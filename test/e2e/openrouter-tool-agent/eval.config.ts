	...
	suites: [
		// Suite 1: Tool use — grading tool calls with deterministic graders.
		{
			...
			cases: [
				...
				{
					id: "weather-and-convert",
					input: {
						prompt:
							"What is the weather in Tokyo, and convert the temperature to Fahrenheit? Use tools for both.",
						system:
							"You are a helpful assistant with access to tools. Always use the appropriate tool to answer questions. Respond with a brief summary after getting tool results.",
					},
					expected: {
						toolCalls: [
							...
							{ name: "convert_temperature", args: { from_unit: "celsius" } },
						],
					},
					category: "multi_step",
				},
